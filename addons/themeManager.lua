...
do
	...
	ThemeManager.BuiltInThemes = {
		["Default"] = {
			...
			httpService:JSONDecode(
				'{"MainColor":"181825","AccentColor":"03b2fd","OutlineColor":"323232","BackgroundColor":"252534","FontColor":"ffe3e3"}'
			),
		},
		["BBot"] = {
			2,
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		groupbox:AddButton("Set as default", function()
			if
				RainOptions.ThemeManager_CustomThemeList.Value ~= nil
				and RainOptions.ThemeManager_CustomThemeList.Value ~= ""
			then
				self:SaveDefault(RainOptions.ThemeManager_CustomThemeList.Value)
				self.Library:Notify(
					string.format("Set default theme to %q", RainOptions.ThemeManager_CustomThemeList.Value)
				)
			end
		end)
