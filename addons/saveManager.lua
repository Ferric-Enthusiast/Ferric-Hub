...
do
	...
	function SaveManager:Save(name)
		...
		if game:GetService("CoreGui"):FindFirstChild("thisisachatloggerpleasebanme") then
			data.chatLoggerPosition =
				udim2ToTable(game:GetService("CoreGui").thisisachatloggerpleasebanme.Frame.Position)
	...
	function SaveManager:Load(name)
		...
		if decoded.keybindPosition and decoded.infoLoggerPosition then
			...
			if decoded.chatLoggerSize and game:GetService("CoreGui"):FindFirstChild("thisisachatloggerpleasebanme") then
				game:GetService("CoreGui").thisisachatloggerpleasebanme.Frame.Size =
					tableToUdim2(decoded.chatLoggerSize)
				game:GetService("CoreGui").thisisachatloggerpleasebanme.Frame.Position =
					tableToUdim2(decoded.chatLoggerPosition)
			end
		end
